...
public class BlockUgalLQueueBasedSwitchGenerator extends NetworkDeviceGenerator {
    ...
    public BlockUgalLQueueBasedSwitchGenerator(IntermediaryGenerator intermediaryGenerator, int numNodes) {
        SimulationLogger.logInfo("Network device", "BLOCK_UGALL_QUEUE_BASED_SWITCH(numNodes=" + numNodes + ")");
    ...
    public NetworkDevice generate(int identifier, TransportLayer transportLayer) {
        ...
        return new BlockUgalLQueueBasedSwitch(identifier, 
                                            transportLayer, 
